...
namespace Bookify.Web.Data.Migrations
{
    ...
    [Migration("20260806090912_AddRentalModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Web.Core.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Bookify.Web.Core.Models.Area", b =>
                {
                    ...
                    b.HasIndex("GovernreteId");

                    b.HasIndex("LastUpdatedById");

                    b.HasIndex("Name", "GovernreteId")
                        .IsUnique();

                    b.ToTable("Areas");
                });

            modelBuilder.Entity("Bookify.Web.Core.Models.Authors", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Web.Core.Models.Governrete", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Web.Core.Models.RentalCopies", b =>
                {
            ...
            modelBuilder.Entity("Bookify.Web.Core.Models.Subscriptions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Web.Core.Models.Area", b =>
                {
                    b.HasOne("Bookify.Web.Core.Models.AppUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("Bookify.Web.Core.Models.Governrete", "Governrete")
                        .WithMany("Areas")
                        .HasForeignKey("GovernreteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Bookify.Web.Core.Models.AppUser", "LastUpdatedBy")
                        .WithMany()
                        .HasForeignKey("LastUpdatedById");

                    b.Navigation("CreatedBy");

                    b.Navigation("Governrete");
            ...
            modelBuilder.Entity("Bookify.Web.Core.Models.Book", b =>
                {
                    b.HasOne("Bookify.Web.Core.Models.Authors", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bookify.Web.Core.Models.AppUser", null)
                        .WithMany()
